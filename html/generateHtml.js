                    ...
                    <td>
                       ...
                       <div style="padding-top: 10px;">
                          <table class="summary" style="border: 1px solid rgb(234, 234, 234);">
                             <thead>
                                <tr>
                                   <th style="width: 60%;text-align: left;">Scenario</th>
                                   <th colspan="2" style="width: 30%;text-align: left;">Process</th>
...
const getSummary = async (custOrderDetail, recapStatus, start, end, diff, duration) => {
    let body = "";
    ...
    for (let i = 0; i < custOrderDetail.length; i++) {
        body +=
            ...
            <td style="text-align: center;font-size: 6px"><i>${duration[i].login} s</i></td>
         </tr>
         <tr>
            ...
            <td style="text-align: center;font-size: 6px"><i>${duration[i].cleansingCart} s</i></td>
         </tr>
         <tr>
            ...
            <td style="text-align: center;font-size: 6px"><i>${custOrderDetail[i].productType === 'Layanan Bengkel'? duration[i].getLocCustomer :'0.00'} s</i></td>
         ...
         <tr>
            ...
            <td style="text-align: center;font-size: 6px"><i>${duration[i].getPDP} s</i></td>
         </tr>
         <tr>
            <td>5. Add to Cart</td>
            <td style="text-align: center">${recapStatus[i].addCart === true? '<i class="fas fa-check"></i>':'<i class="fas fa-times"></i>'}</td>
            <td style="text-align: center;font-size: 6px"><i>${duration[i].addCart} s</i></td>
         </tr>
         <tr>
            ...
            <td style="text-align: center;font-size: 6px"><i>${duration[i].applyPoint} s</i></td>
         </tr>
         <tr>
            ...
            <td style="text-align: center;font-size: 6px"><i>${duration[i].applyCoupon} s</i></td>
         </tr>
         <tr>
            ...
            <td style="text-align: center;font-size: 6px"><i>${duration[i].order} s</i></td>
         </tr>
         <tr>
            ...
            <td style="text-align: center;font-size: 6px"><i>${duration[i].cancel} s</i></td>
         </tr>
                `
    }
                     ...
                     <td colspan="4">
                        <table class="validation">
                           ...
                           <tr>
                                ...
                                <td>${custOrderDetail[i].afterOrderTotalAvailOutlet === 'It is not product service order'  || custOrderDetail[i].afterOrderTotalAvailOutlet === '' ? custOrderDetail[i].afterOrderTotalAvail : custOrderDetail[i].afterOrderTotalAvailOutlet}</td>
                                <td>${custOrderDetail[i].afterCancelTotalAvailOutlet === 'It is not product service order'  || custOrderDetail[i].afterCancelTotalAvailOutlet === '' ? custOrderDetail[i].afterCancelTotalAvail : custOrderDetail[i].afterCancelTotalAvailOutlet}</td>
                           </tr>
                        </table>
                     </td>
                  </tr>
...
const getHtmlData = async(custOrderDetail, recapStatus, start, end, diff, duration) => {
    let section1 = await getSummary(custOrderDetail,recapStatus,start,end,diff,duration);
